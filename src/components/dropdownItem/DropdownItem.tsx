...
const DropdownItem: FC<DropdownItemProps> = ({selected, category, all, children, color, manager_id, circle_progress}) => {
    return (
        <div>
            <div className=' min-w-[300px] flex items-center justify-between gap-4'>
                <div className='flex items-center gap-4'>
                    ...
                    {all === 'yes'
                        ? <p className='text-sm font-medium'>Все <span className='opacity-35'>(default)</span></p>
                    ...
                    {category === 'project' &&
                        <div className='flex gap-1'>
                            {all === 'yes'
                                ...
                                : <div className={classNames(['w-3 h-3 rounded-[3px]'], {
